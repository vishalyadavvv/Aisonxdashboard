...
import { Globe, Sparkles, ArrowLeft, FileText, ExternalLink, Search, TrendingUp, Tag, Target, Terminal, FileDown, AlertTriangle, CheckCircle2, Layout, Zap, Eye, RefreshCw, Loader2} from 'lucide-react';
              ...
              <div className="bg-blue-600/5 border-y border-blue-100/50 py-3 px-4 flex items-center justify-between shadow-[inset_0_1px_2px_rgba(0,0,0,0.01)]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-blue-600/70 font-bold uppercase tracking-widest mt-1">Updating architectural map & Perceptual nodes (30-60s) • Live sync active</p>
                  </div>
                </div>
                <div className="hidden md:flex items-center gap-2">
                  <div className="flex items-center gap-2 px-2.5 py-1 bg-white/80 rounded-lg border border-blue-100/50 backdrop-blur-sm">
                    ...
                    <span className="text-[9px] font-black text-blue-600 uppercase tracking-widest">Profiling Node</span>
                  </div>
                </div>
              </div>
            </motion.div>
