              ...
              <div className="bg-blue-600/5 border-y border-blue-100/50 py-3 px-4 flex items-center justify-between shadow-[inset_0_1px_2px_rgba(0,0,0,0.01)]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-blue-600/70 font-bold uppercase tracking-widest mt-1">Updating Knowledge Graph nodes & Digital Authority (30-60s) • Live sync active</p>
                  </div>
                </div>
