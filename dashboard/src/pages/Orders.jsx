    ...
    <div className="max-w-6xl mx-auto space-y-8 py-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-700 font-medium">Manage your subscriptions and download invoices.</p>
        </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-100">
                <th className="px-6 py-4 text-[10px] font-bold text-gray-600 uppercase tracking-widest">Order ID / Invoice</th>
                <th className="px-6 py-4 text-[10px] font-bold text-gray-600 uppercase tracking-widest">Date</th>
                <th className="px-6 py-4 text-[10px] font-bold text-gray-600 uppercase tracking-widest">Amount</th>
                  ...
                  >
                    <td className="px-6 py-5">
                      <div className="flex flex-col">
                        <span className="text-sm font-bold text-gray-800 capitalize">{order.planName} Plan</span>
                        <span className="text-[10px] text-gray-600 font-mono">{order.orderId || '—'}</span>
                      </div>
                    </td>
                    <td className="px-6 py-5">
                    ...
                    <td className="px-6 py-5">
                      <span className="text-sm font-bold text-gray-800">₹{Number(order.amount).toFixed(2)}</span>
                    </td>
                    <td className="px-6 py-5">
                      {getStatusBadge('paid')}
                    </td>
                    <td className="px-6 py-5 text-right">
                      <span className="p-2 text-gray-600 inline-flex items-center gap-2 text-xs font-bold">
      ...
      <div className="bg-slate-50 rounded-2xl p-6 flex items-start gap-4">
        ...
        <div className="space-y-1">
          <p className="text-sm font-bold text-gray-800">About your billing</p>
