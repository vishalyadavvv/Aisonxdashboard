...
// Ensure we are connecting directly to the 'Franchise' database
const sourceUri = "mongodb+srv://vishaldgtldb:Ram%40123@cluster0.llotsdg.mongodb.net/Franchise?retryWrites=true&w=majority&appName=Cluster0";
const destUri = "mongodb+srv://dgtlmarttech_db_user:GognVTBpQRRWZwZb@cluster0.twmpfgv.mongodb.net/Franchise?retryWrites=true&w=majority";

async function migrate() {
    console.log("==================================================");
    console.log("Starting Migration for 'Franchise' database ONLY");
    console.log("==================================================");
    ...
    try {
        ...
        const sourceDb = sourceClient.db('Franchise');
        const destDb = destClient.db('Franchise');
        ...
        console.log("\n==================================================");
        console.log("🎉 SUCCESS: Franchise Database Migration Completed!");
        console.log("==================================================");
